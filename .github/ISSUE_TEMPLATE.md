<!--
Thanks for taking the time to draft up an issue for Axon Server Connector Java!
Prior to starting off, please read the following:

## Usage Questions

If you are having difficulty using Axon Server Connector Java, take the following into account:
...
You can find all three of them [here](https://github.com/axonserver-connector-java/issues/new/choose). 
